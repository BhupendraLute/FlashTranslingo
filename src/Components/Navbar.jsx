...
function Navbar() {
  ...
  return (
    <nav className="w-full dark:bg-[#0f0f32] dark:text-white py-4 px-12 shadow-sm">
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          <div className="text-black text-2xl font-bold dark:text-white">FlashTranslingo</div>
