...
function Hero() {
    return (
        <section className="w-full min-h-[85vh] text-center p-14 flex flex-col md:flex-row justify-center overflow-hidden">
            ...
            <div className="relative flex-1 flex items-center justify-center max-md:hidden">
                <div className="absolute max-sm:hidden bg-orange-500 w-[10rem] h-[10rem] rounded-full right-[-1.5rem] top-[-1.5rem] z-10"></div>
                <img src="assets/images/hero-img.jpg" alt="heor-image" className='relative w-full h-[60%] md:h-[75%] p-1 lg:p-10 rounded-2xl lg:rounded-[3.5rem] overflow-hidden z-50' />
                <div className="absolute max-sm:hidden bg-orange-300 w-[18rem] h-[18rem] rounded-full left-[-3rem] bottom-0 z-10"></div>
            </div>
        </section>
    )
}
